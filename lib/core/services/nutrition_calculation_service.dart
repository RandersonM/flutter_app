...
class NutritionCalculationService {
  ...
  static String getActivityLevelDisplayName(
      String key, Function(String) getLocalizedString) {
    switch (key) {
      case 'sedentary':
        return getLocalizedString('sedentary');
      case 'light':
        return getLocalizedString('light');
      case 'moderate':
        return getLocalizedString('moderate');
      case 'active':
        return getLocalizedString('active');
      case 'very_active':
        return getLocalizedString('veryActive');
      default:
        return key;
    }
  }

  static String getGoalDisplayName(
      String key, Function(String) getLocalizedString) {
    switch (key) {
      case 'weight_loss':
        return getLocalizedString('weightLoss');
      case 'maintenance':
        return getLocalizedString('maintenance');
      case 'muscle_gain':
        return getLocalizedString('muscleGain');
      default:
        return key;
    }
  }
