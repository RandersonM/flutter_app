...
class CustomCharacterRoutes implements FeatureRouteModule {
  ...
  @override
  List<String> get routes => [createCustomCharacter, customCharacterList, editCustomCharacter];

  @override
  Set<String> get privateRoutes => {createCustomCharacter, customCharacterList, editCustomCharacter};
