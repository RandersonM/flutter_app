          ...
          children: [
            ...
            SimpleVideoBanner(
              ...
              bannerType: _bannerContent[_currentBannerIndex]['type']
                  as SimpleBannerType,
              height: 200,
              title: _bannerContent[_currentBannerIndex]['title'] as String?,
              subtitle:
                  _bannerContent[_currentBannerIndex]['subtitle'] as String?,
            ),
            ...
            CharacterInfoCard(
              ...
              characterBounty: "฿3,000,000,000",
              characterImage:
                  "https://i.pinimg.com/564x/12/48/99/124899eb0e92ca7e2a8715ab24fc1915.jpg",
              onTap: () {
                // TODO: Navegar para detalhes do personagem
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text('Navegação para detalhes será implementada!'),
              ...
              children: [
                Expanded(
                  child: ElevatedButton.icon(
                    onPressed: () {
                      setState(() {
                        _currentBannerIndex =
                            (_currentBannerIndex + 1) % _bannerContent.length;
                      });
                    },
                ...
                Expanded(
                  child: OutlinedButton.icon(
                    onPressed: () {
                      // TODO: Implementar busca de personagem aleatório
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content:
                              Text('Personagem aleatório será implementado!'),
                        ),
                      );
                    },
